...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .style = .{ .flex_grow = 1 } } };
var root = Node{ .style = .{ .width = -1, .height = -1, .background_color = Color.rgb(0, 0, 0) }, .children = &_arr_0 };
