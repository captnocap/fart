      ...
      variants: [
        {
          ...
          name: 'Comfortable',
          render: () => (
            <Box style={{ width: 460, padding: 16, backgroundColor: '#eadfca', borderRadius: 4 }}>
              <Col style={{ gap: 14 }}>
                <DocumentBlock
                ...
                <DocumentBlock
                  block={{
                    type: 'paragraph',
                    text: 'A paragraph reads at body size with relaxed leading. The block component is unaware of its siblings; it just takes a block prop.',
                  }}
                  size="comfortable"
                />
                <DocumentBlock
        ...
        },
        {
          ...
          name: 'Compact',
          render: () => (
            <Box style={{ width: 280, padding: 12, backgroundColor: '#eadfca', borderRadius: 4 }}>
              <Col style={{ gap: 10 }}>
                <DocumentBlock
