...
fn buildGGMLVulkan(
    ...
    //mod.addCMacro("VK_NV_cooperative_matrix", ""); // disabled: system glslc too old
    //mod.addCMacro("VK_NV_cooperative_matrix2", ""); // disabled: system glslc too old
    //mod.addCMacro("GGML_VULKAN_INTEGER_DOT_GLSLC_SUPPORT", ""); // disabled: system glslc too old
    //mod.addCMacro("GGML_VULKAN_BFLOAT16_GLSLC_SUPPORT", ""); // disabled: system glslc too old
    //mod.addCMacro("GGML_VULKAN_COOPMAT_GLSLC_SUPPORT", ""); // disabled: system glslc too old
    //mod.addCMacro("GGML_VULKAN_COOPMAT2_GLSLC_SUPPORT", ""); // disabled: system glslc too old
...
fn genVulkanShaders(
    ...
    // Use system glslc instead of building shaderc from source
    const glslc_path = b.findProgram(&.{"glslc"}, &.{}) catch @panic("glslc not found — install glslc or shaderc");
...
fn buildVulkanShadersGen(b: *std.Build) *std.Build.Step.Compile {
    ...
    //mod.addCMacro("VK_NV_cooperative_matrix", ""); // disabled: system glslc too old
    //mod.addCMacro("VK_NV_cooperative_matrix2", ""); // disabled: system glslc too old
    //mod.addCMacro("COOPMAT", ""); // disabled: system glslc too old
    //mod.addCMacro("COOPMAT2", ""); // disabled: system glslc too old
