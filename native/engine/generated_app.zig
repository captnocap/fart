...
var _arr_0 = [_]Node{ .{ .text = "", .font_size = 36, .text_color = Color.rgb(255, 121, 198) }, .{ .text = "MB leaked", .font_size = 12, .text_color = Color.rgb(102, 102, 136) } };
var _arr_1 = [_]Node{ .{ .text = "Leak 64MB (click repeatedly)", .font_size = 16, .text_color = Color.rgb(255, 255, 255) } };
var _arr_2 = [_]Node{ .{ .text = "Watchdog: 512MB hard limit, 50MB/s rate limit. Should auto-kill.", .font_size = 11, .text_color = Color.rgb(85, 85, 102) } };
var _arr_3 = [_]Node{ .{ .text = "Leak Test", .font_size = 28, .text_color = Color.rgb(255, 255, 255) }, .{ .text = "This app intentionally leaks memory. The watchdog should kill it.", .font_size = 14, .text_color = Color.rgb(235, 87, 87) }, .{ .style = .{ .padding = 20, .background_color = Color.rgb(40, 40, 56) }, .children = &_arr_0 }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(235, 87, 87) }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_1 }, .{ .style = .{ .padding = 12, .background_color = Color.rgb(22, 22, 30) }, .children = &_arr_2 } };
var root = Node{  .style = .{ .width = 500, .padding = 32, .flex_direction = .column, .gap = 16, .background_color = Color.rgb(30, 30, 42) }, .children = &_arr_3 } ;
...
fn _handler_press_0() void {
    state.setSlot(0, leaktest.leak64());
}
