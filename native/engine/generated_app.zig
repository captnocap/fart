...
var _arr_0 = [_]Node{ .{ .text = "", .font_size = 42, .text_color = Color.rgb(255, 121, 198) }, .{ .text = "Unix timestamp (seconds since epoch)", .font_size = 12, .text_color = Color.rgb(102, 102, 136) } };
var _arr_1 = [_]Node{ .{ .text = "Get Time (libc FFI)", .font_size = 16, .text_color = Color.rgb(255, 255, 255) } };
var _arr_2 = [_]Node{ .{ .text = "TypeScript → Zig @cImport → libc time() → native call. Zero overhead.", .font_size = 11, .text_color = Color.rgb(85, 85, 102) } };
var _arr_3 = [_]Node{ .{ .text = "FFI Demo", .font_size = 28, .text_color = Color.rgb(255, 255, 255) }, .{ .text = "Calling libc time() directly from TypeScript.", .font_size = 14, .text_color = Color.rgb(120, 120, 140) }, .{ .style = .{ .padding = 20, .background_color = Color.rgb(40, 40, 56) }, .children = &_arr_0 }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(78, 201, 176) }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_1 }, .{ .style = .{ .padding = 12, .background_color = Color.rgb(22, 22, 30) }, .children = &_arr_2 } };
