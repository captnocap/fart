...
with open('tsz/carts/3d-ui-experiment/taskboard.app.tsz') as f:
    tb_src = f.read()
...
with open('tsz/carts/3d-ui-experiment/dashboard.app.tsz') as f:
    db_src = f.read()
...
with open('tsz/carts/3d-ui-experiment/terminal3d.app.tsz') as f:
    tr_src = f.read()
