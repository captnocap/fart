...
// include: /tmp/tmpfgam7mks.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/font.ttf", "start": 0, "end": 276452}], "remote_package_size": 276452});
...
function findWasmBinary() {
  return locateFile('tsz-web.wasm');
}
...
/** @type {function(string, boolean=, number=)} */
  ...
  fillAdapterInfoStruct:(info, infoStruct) => {
        ...
        HEAP32[(((infoStruct)+(52))>>2)] = info.subgroupMinSize;checkInt32(info.subgroupMinSize);
        HEAP32[(((infoStruct)+(56))>>2)] = info.subgroupMaxSize;checkInt32(info.subgroupMaxSize);
        ...
        HEAP32[(((infoStruct)+(36))>>2)] = 2;checkInt32(2);
        var adapterType = info.isFallbackAdapter ? 3 : 4;
        HEAP32[(((infoStruct)+(40))>>2)] = adapterType;checkInt32(adapterType);
        HEAP32[(((infoStruct)+(44))>>2)] = 0;checkInt32(0);
        HEAP32[(((infoStruct)+(48))>>2)] = 0;checkInt32(0);
      },
  ...
  var _wgpuSurfaceGetCurrentTexture = (surfacePtr, surfaceTexturePtr) => {
      ...
      try {
        ...
        HEAP32[(((surfaceTexturePtr)+(8))>>2)] = 1;checkInt32(1);
      } catch (ex) {
        err(`wgpuSurfaceGetCurrentTexture() failed: ${ex}`);
        HEAPU32[(((surfaceTexturePtr)+(4))>>2)] = 0;
        HEAP32[(((surfaceTexturePtr)+(8))>>2)] = 6;checkInt32(6);
      }
    };
