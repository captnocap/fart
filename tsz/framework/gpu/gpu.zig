...
pub const textPipelineReady = text.pipelineReady;
pub const textBufferReady = text.bufferReady;
pub const textBindGroupReady = text.bindGroupReady;
pub const textGlyphCount = text.count;
