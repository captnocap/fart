...
var _arr_0 = [_]Node{ .{ .text = "Dynamic Bars", .font_size = 16, .text_color = Color.rgb(187, 134, 252) }, .{ .style = .{ .gap = 8 } } };
var _root = Node{ .style = .{ .background_color = Color.rgb(18, 18, 18), .padding = 20, .width = -1, .height = -1, .gap = 8 }, .children = &_arr_0 };
...
var _oa0_pct: []i64 = &[_]i64{};
var _oa0_pct_cap: usize = 0;
...
var _map_inner_0: [MAX_MAP_0][4]Node = undefined;
...
fn _rebuildMap0() void {
    ...
    for (0.._map_count_0) |_i| {
        ...
        _map_texts_0_2[_i] = std.fmt.bufPrint(&_map_text_bufs_0_2[_i], "{d}%", .{ _oa0_pct[_i] }) catch "";
        _map_inner_0[_i] = [4]Node{ .{ .style = .{ .width = 60 }, .text = _map_texts_0_0[_i], .font_size = 11, .text_color = Color.rgb(224, 224, 224) }, .{ .style = .{ .height = 20, .background_color = Color.rgb(@intCast((_oa0_color[_i] >> 16) & 0xFF), @intCast((_oa0_color[_i] >> 8) & 0xFF), @intCast(_oa0_color[_i] & 0xFF)), .border_radius = 4 } }, .{ .text = _map_texts_0_2[_i], .font_size = 10, .text_color = Color.rgb(136, 136, 136) }, .{ .text = "*", .font_size = 10, .text_color = Color.rgb(187, 134, 252) } };
        _map_pool_0[_i] = .{ .style = .{ .flex_direction = .row, .align_items = .center, .gap = 8, .padding = 6 }, .children = &_map_inner_0[_i], .handlers = .{ .lua_on_press = _map_lua_ptrs_0[_i] } };
    }
...
const LUA_LOGIC =
    ...
    \\local highlight = 0
    \\
    \\function setHighlight(v) highlight = v; __setState(0, v) end
    \\
    \\local bars = {}
    \\function setBars(v) bars = v; __setObjArr0(v) end
    \\local b = {
    \\  { pct = 85, color = 0x03dac6, label = 'Rust' },
    \\  { pct = 72, color = 0xbb86fc, label = 'Zig' },
    \\  { pct = 60, color = 0xcf6679, label = 'C' },
...
fn _updateConditionals() void {
    _arr_0[3].style.display = if ((state.getSlot(0) == i)) .flex else .none;
}
