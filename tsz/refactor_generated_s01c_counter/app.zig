//! Generated by tsz compiler — s01c_counter [app.zig]
...
const updates = @import("runtime_updates.zig");
const js_logic = @import("js_logic.zig");
const lua_logic = @import("lua_logic.zig");

fn _appInit() void {
    st._initState();
    updates._updateDynamicTexts();
}

fn _appTick(now: u32) void {
    _ = now;
    if (state.isDirty()) { updates._updateDynamicTexts(); state.clearDirty(); }
}
...
export fn app_get_js_logic() [*]const u8 { return js_logic.JS_LOGIC.ptr; }
export fn app_get_js_logic_len() usize { return js_logic.JS_LOGIC.len; }
export fn app_get_lua_logic() [*]const u8 { return lua_logic.LUA_LOGIC.ptr; }
export fn app_get_lua_logic_len() usize { return lua_logic.LUA_LOGIC.len; }
...
pub fn main() !void {
    try engine.run(.{
        .title = "s01c_counter",
        .root = &nodes._root,
        .js_logic = js_logic.JS_LOGIC,
        .lua_logic = lua_logic.LUA_LOGIC,
        .init = _appInit,
        .tick = _appTick,
    });
}
