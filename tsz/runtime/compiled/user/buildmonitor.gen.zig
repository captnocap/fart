...
//!
//! Source: tsz/examples/multi-file/BuildMonitor.tsz
//! Generated by: tsz compile-runtime
//!
//! To regenerate: tsz compile-runtime tsz/examples/multi-file/BuildMonitor.tsz
//! To modify: edit BuildMonitor.tsz and recompile
...
// ── Panel identity ───────────────────────────────────────────
pub const PANEL_ID = "buildmonitor";
...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .text = "BUILDS", .text_color = Color.rgb(85, 85, 85) }, .{ .text = "", .font_size = 28 } };
var _arr_1 = [_]Node{ .{ .text = "PASSED", .text_color = Color.rgb(85, 85, 85) }, .{ .text = "", .font_size = 28 } };
var _arr_2 = [_]Node{ .{ .text = "WARNINGS", .text_color = Color.rgb(85, 85, 85) }, .{ .text = "", .font_size = 28 } };
...
var _arr_4 = [_]Node{ .{ .text = "Trigger Build", .text_color = Color.rgb(255, 255, 255) } };
var _arr_5 = [_]Node{ .{ .text = "Build Monitor", .text_color = Color.rgb(233, 69, 96) }, .{ .text = "internal tooling — compiled to .gen.zig fragment", .text_color = Color.rgb(85, 85, 85) }, .{ .style = .{ .flex_direction = .row, .margin_top = 16 }, .children = &_arr_3 }, .{ .style = .{ .padding = 12, .background_color = Color.rgb(15, 52, 96), .border_radius = 6, .margin_top = 8 }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_4 } };
var _arr_6 = [_]Node{ .{ .text = "Build Monitor", .text_color = Color.rgb(78, 201, 176) }, .{ .text = "internal tooling", .text_color = Color.rgb(85, 85, 85) } };
