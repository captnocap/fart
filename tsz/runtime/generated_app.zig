...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .text = "Rotate +15°", .font_size = 14, .text_color = Color.rgb(255, 255, 255) } };
var _arr_1 = [_]Node{ .{ .text = "Reset", .font_size = 14, .text_color = Color.rgb(255, 255, 255) } };
var _arr_2 = [_]Node{ .{ .style = .{ .padding = 16, .background_color = Color.rgb(78, 201, 176), .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_0 }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(86, 156, 214), .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_1 }, .children = &_arr_1 } };
var _arr_3 = [_]Node{ .{ .text = "Rotated Card", .font_size = 18, .text_color = Color.rgb(255, 121, 198) }, .{ .text = "This box is rotated 15°", .font_size = 12, .text_color = Color.rgb(128, 128, 128) } };
var _arr_4 = [_]Node{ .{ .text = "Scaled Card", .font_size = 18, .text_color = Color.rgb(229, 192, 123) }, .{ .text = "This box is 1.5x scaled", .font_size = 12, .text_color = Color.rgb(128, 128, 128) } };
var _arr_5 = [_]Node{ .{ .text = "Compositor Test", .font_size = 20, .text_color = Color.rgb(255, 255, 255) }, .{ .text = "Click the button to rotate the card", .font_size = 14, .text_color = Color.rgb(128, 128, 128) }, .{ .style = .{ .flex_direction = .row, .gap = 16, .margin_top = 16 }, .children = &_arr_2 }, .{ .style = .{ .margin_top = 32, .padding = 24, .background_color = Color.rgb(45, 45, 63), .border_radius = 12, .width = 200, .height = 120, .rotation = 15, .opacity = 0.9 }, .children = &_arr_3 }, .{ .style = .{ .margin_top = 32, .padding = 24, .background_color = Color.rgb(61, 61, 95), .border_radius = 12, .width = 200, .height = 120, .scale_x = 1.5, .scale_y = 1.5, .opacity = 0.8 }, .children = &_arr_4 } };
var root = Node{ .style = .{ .padding = 32, .background_color = Color.rgb(30, 30, 42), .width = -1, .height = -1 }, .children = &_arr_5 };

// ── Generated event handlers ────────────────────────────────────
fn _handler_press_0() void {
    state.setSlot(0, (state.getSlot(0) + 15));
}
