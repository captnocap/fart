...
//!
//! Source: conditional-local-test.tsz
...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .text = "Toggle Mode", .font_size = 14, .text_color = Color.rgb(255, 255, 255) } };
var _arr_1 = [_]Node{ .{ .font_size = 20, .text_color = Color.rgb(255, 255, 255) }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(78, 201, 176), .border_radius = 8, .margin_top = 16 }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_0 } };
var root = Node{ .style = .{ .padding = 32, .background_color = Color.rgb(255, 255, 255), .width = -1, .height = -1 }, .children = &_arr_1 };

// ── Generated event handlers ────────────────────────────────────
fn _handler_press_0() void {
    state.setSlot(0, (state.getSlot(0) == 0));
}
...
pub fn main() !void {
    ...
    geometry.init("conditional-local-test");
