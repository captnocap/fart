...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .text = "", .font_size = 13, .text_color = Color.rgb(166, 173, 200) } };
var _arr_1 = [_]Node{ .{ .text = "Terminal Test (PTY + libvterm)", .font_size = 14, .text_color = Color.rgb(205, 214, 244) }, .{ .style = .{ .margin_top = 8, .padding = 4, .background_color = Color.rgb(17, 17, 27), .flex_grow = 1 }, .children = &_arr_0 } };
var root = Node{ .style = .{ .width = -1, .height = -1, .background_color = Color.rgb(30, 30, 46), .padding = 8 }, .children = &_arr_1 };
...
fn updateDynamicTexts() void {
    _dyn_text_0 = std.fmt.bufPrint(&_dyn_buf_0, "Frame: {d}", .{ state.getSlot(0) }) catch "";
