...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .text = "Go to Settings", .font_size = 16, .text_color = Color.rgb(255, 255, 255) } };
var _arr_1 = [_]Node{ .{ .text = "Go to About", .font_size = 16, .text_color = Color.rgb(255, 255, 255) } };
var _arr_2 = [_]Node{ .{ .text = "Home Page", .font_size = 24, .text_color = Color.rgb(255, 255, 255) }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(78, 201, 176), .margin_top = 8, .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_0 }, .children = &_arr_0 }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(86, 156, 214), .margin_top = 8, .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_1 }, .children = &_arr_1 } };
var _arr_3 = [_]Node{ .{ .text = "Back to Home", .font_size = 16, .text_color = Color.rgb(255, 255, 255) } };
var _arr_4 = [_]Node{ .{ .text = "Settings Page", .font_size = 24, .text_color = Color.rgb(255, 255, 255) }, .{ .text = "Configure your preferences here", .font_size = 14, .text_color = Color.rgb(136, 136, 136) }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(86, 156, 214), .margin_top = 16, .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_2 }, .children = &_arr_3 } };
var _arr_5 = [_]Node{ .{ .text = "Back to Home", .font_size = 16, .text_color = Color.rgb(255, 255, 255) } };
var _arr_6 = [_]Node{ .{ .text = "About Page", .font_size = 24, .text_color = Color.rgb(255, 255, 255) }, .{ .text = "tsz compile-time router demo", .font_size = 14, .text_color = Color.rgb(136, 136, 136) }, .{ .style = .{ .padding = 16, .background_color = Color.rgb(86, 156, 214), .margin_top = 16, .border_radius = 8 }, .handlers = .{ .on_press = _handler_press_3 }, .children = &_arr_5 } };
var _arr_7 = [_]Node{ .{ .style = .{ .padding = 32, .background_color = Color.rgb(30, 30, 42), .flex_grow = 1 }, .children = &_arr_2 }, .{ .style = .{ .padding = 32, .background_color = Color.rgb(45, 45, 61), .flex_grow = 1 }, .children = &_arr_4 }, .{ .style = .{ .padding = 32, .background_color = Color.rgb(26, 42, 26), .flex_grow = 1 }, .children = &_arr_6 } };
var _arr_8 = [_]Node{ .{ .children = &_arr_7 } };
var root = Node{ .style = .{ .width = -1, .height = -1 }, .children = &_arr_8 };
...
fn updateRoutes() void {
    ...
    const patterns = [_][]const u8{ "/", "/settings", "/about" };
    const best = router.findBestMatch(&patterns, path);
    _arr_3[0].style.display = .none;
    _arr_6[1].style.display = .none;
    _arr_7[2].style.display = .none;
    if (best) |idx| {
        switch (idx) {
            0 => { _arr_3[0].style.display = .flex; },
            1 => { _arr_6[1].style.display = .flex; },
            2 => { _arr_7[2].style.display = .flex; },
            else => {},
        }
    }
}
