...
// ── Generated node tree ─────────────────────────────────────────
var _arr_0 = [_]Node{ .{ .text = "Zig", .font_size = 11, .text_color = Color.rgb(255, 255, 255) } };
var _arr_1 = [_]Node{ .{ .text = "SDL2", .font_size = 11, .text_color = Color.rgb(255, 255, 255) } };
var _arr_2 = [_]Node{ .{ .text = "No Runtime", .font_size = 11, .text_color = Color.rgb(255, 255, 255) } };
var _arr_3 = [_]Node{ .{ .style = .{ .padding = 6, .padding_left = 12, .padding_right = 12, .background_color = Color.rgb(247, 164, 29), .border_radius = 4 }, .children = &_arr_0 }, .{ .style = .{ .padding = 6, .padding_left = 12, .padding_right = 12, .background_color = Color.rgb(26, 95, 180), .border_radius = 4 }, .children = &_arr_1 }, .{ .style = .{ .padding = 6, .padding_left = 12, .padding_right = 12, .background_color = Color.rgb(78, 201, 176), .border_radius = 4 }, .children = &_arr_2 } };
var _arr_4 = [_]Node{ .{ .text = "Component Test", .font_size = 20, .text_color = Color.rgb(255, 255, 255) }, .{ .style = .{ .flex_direction = .row, .gap = 8, .margin_top = 16 }, .children = &_arr_3 } };
var root = Node{ .style = .{ .padding = 32, .background_color = Color.rgb(30, 30, 42), .width = -1, .height = -1 }, .children = &_arr_4 };
